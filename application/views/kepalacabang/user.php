      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="<?php echo base_url('kepalacabang/user'); ?>"  class="nav-link active">
              <ion-icon name="person-outline"></ion-icon>
              <p>
                User
              </p>
            </a>
            <a href="<?php echo base_url('kepalacabang/upload'); ?>"  class="nav-link">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      ...
                      <form action="<?php echo base_url('kepalacabang/user/add'); ?>" method="post">
                    </button>
                  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        <div class="modal-header">
          ...
          <form action="<?php echo base_url('kepalacabang/user/delete'); ?>" method="post" class="form-horizontal" role="form">
        </div>
        <div class="modal-body">
            <h4>Konfirmasi</h4>
