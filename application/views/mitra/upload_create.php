            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse">
                <i class="fas fa-minus"></i>
                 <form action="<?=base_url('mitra/upload/create')?>" method="post" enctype="multipart/form-data" id="frm-mhs">
              </button>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>NIK</label>
                  <input type="number" class="form-control" name="nik" id="nik" maxlength="17" minlength="16" placeholder="Nomor Induk Kependudukan" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
               ...
               <div class="row">
                      ...
                      <div class="input-group input-group-lg  mb-3">
                        <div class="input-group-prepend">
                          ...
                          <div class="col-md-9">
                          <div class="form-group">
                            <input type="number" class="form-control"  placeholder="Nomor Rekening" name="no_rek" required>
                          </div>
                        </div>
                      </div>
                    </div>
