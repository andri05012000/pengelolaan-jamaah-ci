          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse">
                ...
                <form action="<?=base_url('mitra/upload/update')?>" method="post" enctype="multipart/form-data">
              </button>
            </div>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>NIK</label>
                  <input type="number" class="form-control" name="nik"  id="icon_telephone"  value="<?=$upload->nik?>" required>
                  <div id="error"><span id="hasilError" class="nameClass" ></span></div>
                </div>
