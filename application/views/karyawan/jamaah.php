             ...
             <div class="card">
              ...
              <div class="card-body">
                <div id="toolbar" style="text-align: right; margin-bottom: 10px;">
                    <a href="<?php echo base_url('karyawan/upload/add'); ?>"  class="on-default edit-row btn btn-info" class="col-sm-6 col-md-4 col-lg-3"><ion-icon name="add"></ion-icon></a>
                </div>
                  ...
                  <tbody>
                    <?php
                      ...
                      <tr>
                        ...
                        <td><?=$upload->nik?></td>
                        <td><?=$upload->jenis_pembayaran?>.<?=$upload->jenis_pembayaran?></td>
                        <td><?=$upload->no_rek?></td>
                        ...
                        <td>
                          <a href ="<?php echo base_url('karyawan/upload/edit/'.$upload->idtabel_jamaah); ?>" class="on-default edit-row btn btn-primary" class="col-sm-6 col-md-4 col-lg-3">
                          <ion-icon name="pencil-outline"></ion-icon></a>
                          <a href="<?php echo base_url('karyawan/upload/delete/'.$upload->idtabel_jamaah); ?>" class="on-default default-row btn btn-danger" class="col-sm-6 col-md-4 col-lg-3">
                              <ion-icon name="trash-outline"></ion-icon></a>
                          </td>
                          <td>
                            <a href="<?php echo base_url('karyawan/upload/detail/'.$upload->idtabel_jamaah); ?>" target="_BLANK" class="on-default default-row btn btn-primary" class="col-sm-6 col-md-4 col-lg-3">
