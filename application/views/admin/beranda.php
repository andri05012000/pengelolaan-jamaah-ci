<?php
include 'koneksi.php';
$admin = mysqli_query($koneksi,"SELECT * FROM tabel_user WHERE level='Admin'");
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-info"><ion-icon name="people-outline"></ion-icon></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Admin</span>
                <span class="info-box-number"><?php echo $jumlahadmin; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
